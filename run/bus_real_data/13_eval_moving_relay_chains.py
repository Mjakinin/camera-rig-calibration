...
STATIC_DET = Path("results/bus_real_data/01_static_a4_marker_detection/detections.csv")
...
def load_colmap_scale():
    ...
    if not ARUCO_SCALE_FILE.exists():
        raise FileNotFoundError(
            ...
            "Run: python3 run/bus_real_data/12_estimate_colmap_scale_from_aruco.py"
        )
