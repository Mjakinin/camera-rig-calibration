...
def main():
    ...
    ap.add_argument("--detections", default="results/bus_real_data/01_marker_direct_relay_multimarker_multichain/.ap01_compat_cache/static_observations/detections.csv")
