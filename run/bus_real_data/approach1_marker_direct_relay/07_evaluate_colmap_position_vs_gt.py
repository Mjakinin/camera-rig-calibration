...
def main():
    ...
    ap.add_argument("--sequence", default="results/bus_real_data/00_shared_baseline/bus_real_data_ref_marker_v1/metadata")
    ap.add_argument("--colmap", default="results/bus_real_data/01_marker_direct_relay_multimarker_multichain/04_moving_camera_colmap_trajectory")
