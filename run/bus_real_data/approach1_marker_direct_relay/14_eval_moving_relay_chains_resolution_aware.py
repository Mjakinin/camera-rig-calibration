#!/usr/bin/env python3
"""Resolution-aware entry point for AP01 moving-relay estimation."""
...
LEGACY_PATH = HERE / "14_eval_moving_relay_chains.py"
if str(HERE) not in sys.path:
    sys.path.insert(0, str(HERE))

spec = importlib.util.spec_from_file_location("ap01_relay_legacy", LEGACY_PATH)
if spec is None or spec.loader is None:
    raise RuntimeError(f"Cannot load AP01 relay implementation: {LEGACY_PATH}")
