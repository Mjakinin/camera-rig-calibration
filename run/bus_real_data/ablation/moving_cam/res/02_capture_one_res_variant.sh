...
if [ -z "$VARIANT" ]; then
  echo "Usage:"
  echo "  ./run/bus_real_data/ablation/moving_cam/res/02_capture_one_res_variant.sh res_640x360"
  echo
  echo "Variants:"
  echo "  res_640x360"
  echo "  res_960x540"
...
WORLD_ROOT="src/calib_lab/bus_real_data/worlds/ablation/moving_cam/res"
OUT_ROOT="results/bus_real_data/ablation/moving_cam/res/00_captures"
