...
WORLD_OUT_ROOT = Path("src/calib_lab/bus_real_data/worlds/ablation/moving_cam/res")
RESULT_OUT_ROOT = Path("results/bus_real_data/ablation/moving_cam/res/00_world_variants")
