...
DATASET_ROOT="results/bus_real_data/ablation/moving_cam/res/00_prepared_datasets"
OUT_ROOT="results/bus_real_data/ablation/moving_cam/res/01_shared_observations"
