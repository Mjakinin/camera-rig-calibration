...
WORLD_VARIANTS = Path("results/bus_real_data/ablation/moving_cam/res/00_world_variants")
CAPTURES = Path("results/bus_real_data/ablation/moving_cam/res/00_captures")
OUT_ROOT = Path("results/bus_real_data/ablation/moving_cam/res/00_prepared_datasets")
