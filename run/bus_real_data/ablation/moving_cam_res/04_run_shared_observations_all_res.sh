...
DATASET_ROOT="results/bus_real_data/ablation/moving_cam_res/00_prepared_datasets"
OUT_ROOT="results/bus_real_data/ablation/moving_cam_res/01_shared_observations"
