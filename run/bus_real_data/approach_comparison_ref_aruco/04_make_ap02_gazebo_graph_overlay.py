...
CAM_EVAL = Path("results/bus_real_data/90_approach_comparison_ref_aruco/02_ref_marker_graph_ba/ap02_static_cameras_ref_aruco_vs_gt.csv")
MARKER_EVAL = Path("results/bus_real_data/90_approach_comparison_ref_aruco/02_ref_marker_graph_ba/ap02_markers_ref_aruco_vs_gt.csv")
...
OUT = Path("results/bus_real_data/90_approach_comparison_ref_aruco/91_gazebo_ap02_graph_debug")
