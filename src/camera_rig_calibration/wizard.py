...
def _setting_rows(
    ...
    from .ui.method_settings import build_setting_rows

    return build_setting_rows(
        job,
        groups,
        defaults_factory=_new_method_job,
...
def _edit_method_job(
    ...
    *,
    ...
    from .ui.method_editor import EditorBindings, edit_method_job
    ...
    return edit_method_job(
        ...
        bindings=EditorBindings(
            ...
            configure_guided_selection=_configure_guided_selection,
            ...
            refresh_method_job_label=_refresh_method_job_label,
