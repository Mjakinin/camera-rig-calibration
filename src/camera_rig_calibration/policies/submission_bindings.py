...
def install_submission_bindings() -> None:
    ...
    with direct imports. The submission policy deliberately wraps those
    ...
    from . import submission_policy
    from ..methods.ap01.automatic_target import automatic_ap01_direct_target
