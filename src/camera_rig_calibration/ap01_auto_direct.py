...
from .methods.ap01.contracts import resolve_ap01_method_contract
...
def automatic_ap01_direct_target(
    ...
    shared markers survive without the legacy top-quality fallback and at least two
    ...
    for target in camera_ids:
        ...
        if direct:
            _, stats = core.aggregate_legacy_direct_candidates(direct, contract)
