...
Main no-GT results:
  ...
  cam_edge_0: 8.431 cm, 2.145 deg via moving_relay_multichain_colmap_motion_aruco_metric_scale
  cam_edge_5: 6.373 cm, 2.802 deg via moving_relay_multichain_colmap_motion_aruco_metric_scale
