...
SDF="/workspaces/project/results/bus_real_data/90_approach_comparison_ref_aruco/91_gazebo_ap02_graph_debug/ap02_graph_presentation_observation_overlay_model.sdf"
