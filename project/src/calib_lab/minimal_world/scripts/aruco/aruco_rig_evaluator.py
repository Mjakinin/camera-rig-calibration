...
class ArucoRigEvaluator(Node):
    def __init__(self):
        ...
        self.declare_parameter("output_csv", "results/minimal_world/aruco/raw_results.csv")
        self.declare_parameter("debug_dir", "results/minimal_world/aruco/debug_images")
