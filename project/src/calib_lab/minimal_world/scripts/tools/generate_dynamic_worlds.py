...
def main():
    ...
    parser.add_argument("--base_world", default="src/calib_lab/minimal_world/worlds/minimal_calib_world.sdf")
    ...
    out_dir = Path("src/calib_lab/minimal_world/worlds/dynamic")
